...
from nutrakinetics_studio.calibration import interaction_parameter_rows
from nutrakinetics_studio.interfaces import SimulationScenario
from nutrakinetics_studio.parameters import core_parameter_catalog_df, supplement_parameter_catalog_df
...
def run_app() -> None:
    ...
    with calibration_tab:
        st.markdown("Calibration hooks are available in `src/nutrakinetics_studio/calibration.py` and `scripts/fit_interactions.py`.")
